        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                try:
                    ...
                    # 6. Generate response using LCEL invoke
...
with st.sidebar:
    ...
    st.info("This is a multilingual, multimodal conversational AI assistant for your NCERT textbooks. Chat in your native language using text, voice, and images!")
